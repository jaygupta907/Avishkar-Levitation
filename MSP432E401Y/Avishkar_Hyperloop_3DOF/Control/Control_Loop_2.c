 ...
 *      Author: ESB203C
 */
#include <Control/Control_Loop_2.h>
#include <Control/Filter.h>
#include <Control/PID_controller.h>
#include "stdint.h"
#include <ti/devices/msp432e4/driverlib/driverlib.h>
#include "uartstdio.h"
void Control_Loop_2(float f32_ADC_data)
{
    static uint32_t ui32_frame_count = 0;
    //static uint32_t ui32_counter_sin = 0;
    float f32_set_point = 8.0f/1000.0f;
    float f32_measured_val =0.015f- f32_ADC_data * POSITION_ENG_CONVERSION_2;
    float PID_out =0.0f;
    ...
    PID_out = PID_Control(&PID_Position_Control_2, f32_err);
    Notch_out=PID_out;
    ...
    /*Update the PWM*/
    MAP_PWMPulseWidthSet(PWM0_BASE, PWM_OUT_4,ui32_period);
}
